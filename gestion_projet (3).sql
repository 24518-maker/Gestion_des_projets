...
--
-- Client :  127.0.0.1
-- Généré le :  Dim 12 Avril 2026 à 11:16
...
(2, '16.00', 'bien', 4, 1, 1, '2026-04-12 09:05:59');
...
(3, 'E-learning platform', '2026-02-15', '2026-04-23', 1),
(4, 'AI CHATBOT', '2026-03-03', '2026-04-11', 1);
...
--
ALTER TABLE `etape`
  ADD CONSTRAINT `fk_etape_projet` FOREIGN KEY (`Id_projet`) REFERENCES `projet` (`Id_projet`);
